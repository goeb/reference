 ...
 *
 * Test example (server running):
 * 1. Call a method
 * dbus-send --session --print-reply --dest=org.gtk.GDBus.TestServer \
 *           /org/gtk/GDBus/TestObject \
 *           org.gtk.GDBus.TestInterface.HelloWorld string:'abcd'
 * method return time=1685041970.279323 sender=:1.59 -> destination=:1.61 serial=71 reply_serial=2
 *    string "You greeted me with 'abcd'. Thanks!"
 * 
 * 2. Receive signals
 * dbus-monitor
 * signal time=1685042494.414847 sender=:1.59 -> destination=(null destination) serial=338 path=/org/gtk/GDBus/TestObject; interface=org.freedesktop.DBus.Properties; member=PropertiesChanged
 ...
 * method return time=1685042811.883342 sender=:1.59 -> destination=:1.71 serial=500 reply_serial=2
 *    variant       string "Back To C!"
 *
 * 4. Set a property
 * dbus-send --session --print-reply --dest=org.gtk.GDBus.TestServer \
 *              /org/gtk/GDBus/TestObject org.freedesktop.DBus.Properties.Set
 *              string:org.gtk.GDBus.TestInterface string:Title variant:string:"Yep, enjoy!"
 *
 */
#include <gio/gio.h>
#include <stdlib.h>
